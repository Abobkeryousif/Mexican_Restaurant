...
namespace Mexican_Restaurant.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Category>().HasData(
                ...
                new Category { CategoryId = 4 , Name = "Desssert" },
            ...
            builder.Entity<Product>().HasData(
                new Product
                {
                    ProductId = 1 ,
                    Name = "Beef Taco",
                    Description = "A dilicous Beef Taco",
                    Price = 2.50m,
                    Stock = 100,
                    CategoryId = 2
                },
                new Product
                {
                    ProductId = 2,
                    Name = "Chicken Taco",
                    Description = "A dilicous Chicken Taco",
                    Price = 1.99m,
                    Stock = 100,
                    CategoryId = 2
                },
                new Product
                {
                    ProductId = 3,
                    Name = "Fish Taco",
                    Description = "A dilicous Fish Taco",
                    Price = 3.99m,
                    Stock = 100,
                    CategoryId = 2
                });
